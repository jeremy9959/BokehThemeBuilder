...
from options import Plot_Options, Toolbar_Options, Grid_Options, Title_Options, Axis_Options
from widgets import ModelBuilder


def button_handler(param_dict, toolbar_param_dict, grid0_param_dict, grid1_param_dict,title_param_dict,xaxis_param_dict,yaxis_param_dict):
    print("Button!")
    P = make_plot(param_dict, toolbar_param_dict, grid0_param_dict, grid1_param_dict,title_param_dict,xaxis_param_dict,yaxis_param_dict)
    print(curdoc().roots)
    layout.children[0]=P
    print(curdoc().roots)
    
def make_plot(param_dict, toolbar_param_dict, grid0_param_dict, grid1_param_dict, title_param_dict, xaxis_param_dict, yaxis_param_dict):
    P = Plot(name="plot", **param_dict)
    ...
    P.add_layout(LinearAxis(ticker=BasicTicker(),formatter=BasicTickFormatter(),**xaxis_param_dict),'below')
    P.add_layout(LinearAxis(ticker=BasicTicker(),formatter=BasicTickFormatter(),**yaxis_param_dict),'left')
...
param_dict, toolbar_param_dict = PlotBuilder.param_dict, ToolbarBuilder.param_dict
...
plot = make_plot(param_dict, toolbar_param_dict, grid0_param_dict, grid1_param_dict,title_param_dict,xaxis_param_dict,yaxis_param_dict)
...
toolbar_panel = Panel(child=column(Print,grid(toolbar_widgets,ncols=3)),title='Toolbar')
...
basic_tabs = [plot_panel,xgrid_panel,ygrid_panel,toolbar_panel,title_panel,xaxis_panel,yaxis_panel]
